...
var ImageViewer = /*#__PURE__*/function () {
  function ImageViewer(element) {
    ...
    _defineProperty(this, "updateImage", function (params) {
      if (!params) {
        return;
      }
      ...
      (0, _util.css)(image, {
        ...
        left: "".concat(params.left, "px"),
        top: "".concat(params.top, "px")
      });
      (0, _util.css)(snapHandle, {
        height: "".concat(params.height, "px"),
        width: "".concat(params.width, "px"),
  ...
  _createClass(ImageViewer, [{
    ...
    key: "_moveHandler",
    value: function _moveHandler(imageCurrentDim) {
      if (!imageCurrentDim) {
        return;
      }

      this._state.imageCurrentDim = imageCurrentDim;
    ...
    key: "_moveSnapHandler",
    value: function _moveSnapHandler(span, img) {
      if (!span || !img) {
        return;
      }

      this._state.snapCurrentDim = _objectSpread(_objectSpread({}, span), img);

      if (this._listeners.onSnapMove) {
        this._listeners.onSnapMove(this._callbackData);
      }
    }
  }, {
