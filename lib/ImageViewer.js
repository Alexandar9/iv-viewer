...
var ImageViewer = /*#__PURE__*/function () {
  function ImageViewer(element) {
    ...
    _defineProperty(this, "updateImage", function (event) {
      var _event$instance, _event$instance$_stat;
      ...
      var snap = _objectSpread(_objectSpread({}, snapHandleDim), EventSnapHandleDim);

      var img = _objectSpread(_objectSpread({}, imageCurrentDim), EventImageCurrentDim);
  ...
  _createClass(ImageViewer, [{
    ...
    value: function _initImageSlider() {
      ...
      var imageSlider = new _Slider["default"](imageWrap, {
        ...
        onMove: function onMove(e, position) {
          ...
          _this2._state.onMoveValues.imageSlider = position;
          _this2._state.onMoveValues.snapSlider = _objectSpread(_objectSpread({}, position), newPos);
     ...
     * @param {*} snapDimension
     */
    function _zoomHandler(imageDimension) {
      console.log("Image: ", imageDimension);
    ...
    function updateMoveImageSlider(event) {
      var _state$onMoveValues,
          _state$onMoveValues$s,
          _state$onMoveValues$s2,
          _this11 = this;
      ...
      var newPos = {
        dx: (_state$onMoveValues = _state.onMoveValues) === null || _state$onMoveValues === void 0 ? void 0 : (_state$onMoveValues$s = _state$onMoveValues.snapSlider) === null || _state$onMoveValues$s === void 0 ? void 0 : _state$onMoveValues$s.dx,
        dy: (_state$onMoveValues$s2 = _state.onMoveValues.snapSlider) === null || _state$onMoveValues$s2 === void 0 ? void 0 : _state$onMoveValues$s2.dy
      ...
      var zoom = function zoom() {
        ...
        if (step < 16) {
          _this11._frames.zoomFrame = requestAnimationFrame(zoom);
        }
        ...
        _this11._state.zoomValue = tickZoom;

        _this11._resizeSnapHandle(imgWidth, imgHeight, newLeft, newTop); // update zoom handle position
        ...
        if (_this11._listeners.onZoomChange) {
          _this11._listeners.onZoomChange(_this11._callbackData);
        }
      }; // zoom();
