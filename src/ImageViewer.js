...
class ImageViewer {
  ...
  get imageViewHtml() {
    ...
    <div class="iv-snap-view">
      ...
      <div class="iv-zoom-actions ${
        this._options.hasZoomButtons ? "iv-zoom-actions--has-buttons" : ""
      }">
        ${this.zoomInButton}
  ...
  constructor(element, options = {}) {
    const { container, domElement, imageSrc, hiResImageSrc } =
      this._findContainerAndImageSrc(element, options);
  ...
  _calculateDimensions() {
    const { image, container, snapView, snapImage, zoomHandle } =
      this._elements;
